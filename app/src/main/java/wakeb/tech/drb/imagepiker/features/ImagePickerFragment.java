...
import wakeb.tech.drb.imagepiker.features.camera.CameraHelper;
import wakeb.tech.drb.imagepiker.features.camera.DefaultCameraModule;
...
import wakeb.tech.drb.imagepiker.features.recyclers.RecyclerViewManager;
import wakeb.tech.drb.imagepiker.helper.ConfigUtils;
import wakeb.tech.drb.imagepiker.helper.ImagePickerPreferences;
import wakeb.tech.drb.imagepiker.helper.IpCrasher;
...
import wakeb.tech.drb.imagepiker.view.SnackBarView;

import static android.app.Activity.RESULT_CANCELED;
import static android.app.Activity.RESULT_OK;
import static wakeb.tech.drb.imagepiker.helper.ImagePickerPreferences.PREF_WRITE_EXTERNAL_STORAGE_REQUESTED;
...
public class ImagePickerFragment extends Fragment implements ImagePickerView {
    ...
    private wakeb.tech.drb.imagepiker.features.ImagePickerConfig config;
    ...
    public static ImagePickerFragment newInstance(@Nullable wakeb.tech.drb.imagepiker.features.ImagePickerConfig config,
                                                  @Nullable CameraOnlyConfig cameraOnlyConfig) {
        ImagePickerFragment fragment = new ImagePickerFragment();
        Bundle args = new Bundle();
        if (config != null) {
            args.putParcelable(wakeb.tech.drb.imagepiker.features.ImagePickerConfig.class.getSimpleName(), config);
        }
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        if (isCameraOnly) {
            ...
            wakeb.tech.drb.imagepiker.features.ImagePickerConfig config = getImagePickerConfig();
            if (config == null) {
                IpCrasher.openIssue();
            }
    ...
    @Nullable
    private wakeb.tech.drb.imagepiker.features.ImagePickerConfig getImagePickerConfig() {
        if (config == null) {
            Bundle bundle = getArguments();
            if (bundle == null) {
                IpCrasher.openIssue();
            }
            boolean hasImagePickerConfig = bundle.containsKey(wakeb.tech.drb.imagepiker.features.ImagePickerConfig.class.getSimpleName());
            boolean hasCameraOnlyConfig = bundle.containsKey(wakeb.tech.drb.imagepiker.features.ImagePickerConfig.class.getSimpleName());

            if (!hasCameraOnlyConfig && !hasImagePickerConfig) {
                IpCrasher.openIssue();
            }
            config = bundle.getParcelable(wakeb.tech.drb.imagepiker.features.ImagePickerConfig.class.getSimpleName());
        }
        return config;
    }
    ...
    private void setupRecyclerView(wakeb.tech.drb.imagepiker.features.ImagePickerConfig config, ArrayList<Image> selectedImages) {
