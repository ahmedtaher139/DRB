...
import wakeb.tech.drb.imagepiker.helper.ViewUtils;
...
public class ImagePickerActivity extends AppCompatActivity implements ImagePickerInteractionListener, ImagePickerView {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        config = getIntent().getExtras().getParcelable(wakeb.tech.drb.imagepiker.features.ImagePickerConfig.class.getSimpleName());
