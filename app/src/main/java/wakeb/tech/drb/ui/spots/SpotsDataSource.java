...
public class SpotsDataSource extends PageKeyedDataSource<Long, SpotModel> {
    ...
    public SpotsDataSource(DataManager dataManager ,SpotViewModel viewModel) {
    ...
    public void loadInitial(@NonNull LoadInitialParams<Long> params, @NonNull LoadInitialCallback<Long, SpotModel> callback) {
        ...
        viewModel.show_public_progress();
                ...
                .subscribe(new Observer<ApiResponse>() {
                    ...
                    public void onNext(ApiResponse apiResponse) {
                        ...
                        if (apiResponse.getStatus()) {
                            ...
                            viewModel.hide_public_progress();
                        } else {
