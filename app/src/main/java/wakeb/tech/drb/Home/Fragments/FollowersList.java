 ...
 */
public class FollowersList extends Fragment implements TripsAdapter.AdapterCallback {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        tripsAdapter = new TripsAdapter(getActivity(), postedTrips_list, dataManager, retrofit, myAPI, FollowersList.this);
